...
namespace CustomList
{
    public class CustomList : IEnumerable<int>
    {
        ...
        {
            return new CustomListEnumerator(_items);
        }
        ...
        public void CopyTo(int[] targetArray, int insertionIndex)
        {
        ...
        public void CopyTo(int insertionIndex, int[] targetArray, int rangeStartIndex, int rangeEndIndex)
        {
        ...
        public void CopyTo(int[] targetArray)
        {
        ...
        public void InsertRange(int insertionIndex, Array[] arrayToInsert)
        {
